...
ggplot() + geom_line(aes(x=ts2, y=x2)) + geom_line(aes(x=ts1, y=x1), color = "blue")+ theme_classic() +  
...
ggplot() + geom_line(aes(x=ts2, y=x2)) + geom_line(aes(x=ts1, y=x1), color = "blue")+ theme_classic() +  
  ggtitle("Representación 2 sinusoides de 150 Hz y 300Hz")
...
El ruido que se escucha se debe a que se esta perdiendo informacion y por tanto la cancion pierde definicion y claridad. En primer lugar se pierden los tonos agudos. 
